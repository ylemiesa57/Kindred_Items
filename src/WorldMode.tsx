    ...
    return (
      <div className="page world-page">
        <section className="world-intro">
          ...
          <p>World Mode keeps the camera active only during this visible session. gpt-oss (via OpenRouter) reasons over the objects you already registered, and voice input runs only when you tap Talk.</p>
          <div className="world-principles">
            ...
            <span><Sparkles size={17} /> gpt-oss reasoning</span>
          </div>
